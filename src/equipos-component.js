...
export class Index2 extends LitElement {
  ...
  @property({ type: String }) nuevoNombreDirector = "";
  @property({ type: String }) nuevoQuienPaga = "";
  @property({ type: String }) nuevoNombreEquipo = "";
  ...
  agregarNuevoEquipo() {
    const nuevoEquipo = {
      nombreDirector: this.nuevoNombreDirector,
      quienPaga: this.nuevoQuienPaga,
      nombreEquipo: this.nuevoNombreEquipo,
    };
    // Agregar el nuevo equipo a la lista de campañas
    this.campanas.push(nuevoEquipo);
    // Reiniciar los campos del formulario
    this.nuevoNombreDirector = "";
    this.nuevoQuienPaga = "";
            ...
            <div class="d-flex p-3" >
              <div class=" border border-dark" style="width: 14rem; height: 33.3rem; border-radius: 1rem;">
                <div>
                  <div class="d-flex  flex-shrink-0 p-3" style="width: 222px; background-color: rgb(201, 205, 207); border-top-left-radius: 1rem; border-radius: 1rem; height: 33.3rem; ">
                    <hr>
                    <ul class="nav nav-pills flex-column mb-auto" style="width: 25rem;">
                      <button @click="${this.mostrarFormularioNuevoEquipo}" class="nav-link active bg-light pt-2 font-weight-bold" style="color: grey; border-radius: 10px; height: 45px; width: 13.5rem; font-size: 18px;">
                        Nuevo Equipo
                      </button>
                    </ul>
                    <hr>
              ...
              <div>
                ...
                ${this.mostrarFormulario
                  ? html`
                    <div class="container mt-4 ml-4" style="border-radius: 1rem; width: 40rem; height: auto;">
                      <form @submit="${(e) => { e.preventDefault(); this.agregarNuevoEquipo(); }}">
                        <div class="form-group">
                          <label for="nombreDirector">Nombre del Director</label>
                          <input type="text" class="form-control" id="nombreDirector" .value="${this.nuevoNombreDirector}" @input="${(e) => this.nuevoNombreDirector = e.target.value}" required>
                        </div>
                        <div class="form-group">
                          <label for="quienPaga">Quién Paga la Campaña</label>
                          <input type="text" class="form-control" id="quienPaga" .value="${this.nuevoQuienPaga}" @input="${(e) => this.nuevoQuienPaga = e.target.value}" required>
                        </div>
                        <div class="form-group">
                          <label for="nombreEquipo">Nombre del Equipo</label>
                          <input type="text" class="form-control" id="nombreEquipo" .value="${this.nuevoNombreEquipo}" @input="${(e) => this.nuevoNombreEquipo = e.target.value}" required>
                        </div>
